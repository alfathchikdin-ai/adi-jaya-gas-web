...
const productName = "Helium";
const productFormula = "He";
const productWaMessage =
    "Halo Adi Jaya Gas, saya ingin menanyakan ketersediaan Helium. Mohon info harga dan ukuran tabung yang tersedia.";
...
const overviewCards = [
    {
        ...
        description:
            "Helium digunakan untuk mendeteksi kebocoran pada sistem, pipa, tangki, dan peralatan tertentu.",
    },
    {
        title: "Laboratorium",
        description:
            "Digunakan untuk berbagai kebutuhan laboratorium dan aplikasi analisis.",
    },
    {
        title: "Kromatografi",
        description:
            "Helium dapat digunakan sebagai gas pembawa pada aplikasi gas chromatography sesuai kebutuhan metode.",
    },
    {
        title: "Welding",
        description:
            "Digunakan sebagai gas pelindung pada proses welding tertentu yang membutuhkan karakteristik helium.",
    },
];
...
const applications = [
    {
        title: "Leak Detection",
        description:
            "Untuk mendeteksi kebocoran pada sistem, pipa, tangki, dan peralatan tertentu.",
        icon: Search,
    },
    {
        title: "Gas Chromatography",
        description:
            "Digunakan sebagai carrier gas dalam aplikasi gas chromatography sesuai kebutuhan metode.",
        icon: Gauge,
    },
    {
        title: "Welding",
    ...
    },
    {
        title: "Laboratorium",
        description:
            "Untuk berbagai kebutuhan analisis, penelitian, dan aplikasi laboratorium.",
        icon: FlaskConical,
    },
];
...
const whyAjgCards = [
    ...
    },
    {
        ...
        description:
            "Melayani kebutuhan industri, laboratorium, welding, dan customer profesional.",
        icon: ShieldCheck,
    },
    {
...
const faqs = [
    {
        question: "Helium digunakan untuk apa?",
        answer:
            "Helium banyak digunakan untuk leak detection, laboratorium, gas chromatography, welding, dan berbagai aplikasi industri tertentu.",
    },
    {
        question: "Apakah Helium tersedia untuk kebutuhan industri?",
        answer:
            "Ya. Kami melayani kebutuhan Helium untuk aplikasi industri, laboratorium, dan kebutuhan profesional sesuai spesifikasi.",
    },
    {
        question: "Apakah Helium bisa digunakan untuk leak detection?",
        answer:
            "Ya. Helium banyak digunakan dalam aplikasi leak detection karena dapat membantu mendeteksi kebocoran pada sistem dan peralatan tertentu.",
    },
    {
        question: "Bagaimana cara mengetahui harga Helium?",
        answer:
...
export function Helium() {
    useEffect(() => {
        document.title = "Supplier Helium Industri Tangerang & Jakarta | Adi Jaya Gas";
    }, []);
                ...
                >
                    ...
                    <div className="aj-container relative z-10 grid gap-10 lg:grid-cols-12 lg:items-center">
                        <div className="lg:col-span-7">
                            <span className="aj-overline !text-[#FF8B33]">HELIUM He</span>
                            <h1 className="mt-5 font-display text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-extrabold leading-[1.05] tracking-tight text-white">
                                <span style={{ color: "#FFFFFF" }}>Supplier Helium</span>
                            ...
                            <p className="mt-6 max-w-xl text-base sm:text-lg leading-relaxed" style={{ color: "#FFFFFF" }}>
                                Helium untuk kebutuhan industri, leak detection,
                                laboratorium, kromatografi, welding, dan berbagai
                ...
                <section className="py-20 lg:py-24">
                    <div className="aj-container">
                        <div className="mx-auto max-w-3xl text-center">
                            <span className="aj-overline !text-[#FF6B00]">HELIUM</span>
                            <h2 className="mt-4 font-display text-3xl font-extrabold text-[#0A2540] sm:text-4xl lg:text-5xl">
                                Helium untuk berbagai kebutuhan operasional
                            </h2>
                            <p className="mt-5 text-base sm:text-lg text-[#475569] leading-relaxed">
                                Helium digunakan untuk mendeteksi kebocoran,
                                mendukung analisis laboratorium, dan kebutuhan
                                aplikasi profesional yang memerlukan presisi.
                            </p>
                        </div>
                ...
                <section className="bg-[#0A2540] py-20 text-white lg:py-24">
                    <div className="aj-container">
                        <div className="mx-auto max-w-3xl text-center">
                            ...
                            >
                                Supplier Helium untuk kebutuhan operasional Anda
                            </h2>
                        </div>
